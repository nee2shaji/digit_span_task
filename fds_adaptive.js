...
if (useAudio) {
	instructions = '<p>On each trial, you will hear a sequence of digits and be asked to type them back in the same order in which they were heard.</p>'+
				   ...
				   '<b style="color:blue;">three</b>, you would respond with <b style="color:blue;">1</b>, <b style="color:blue;">2</b>, <b style="color:blue;">3</b>' +
				   '<br>Kindly ensure your audio is on and you are able to hear loud and clear the following clip</p>'+ 
				   '<audio controls><source src="digits/volumetest.wav" type="audio/wav">Your browser does not support the audio element.</audio> ';
} else {
...
stimulus: '<p>Let\'s begin!</b></p>' +instructions +
	...
	'<p>There will be 24 total trials - 12 each in English and Hindi. Participation takes around 10 minutes.</p>',
choices: ['Continue']
};
...
var fds_adaptive = {
	...
	timeline: [fds_welcome, fds_mainproc]
};
...
var aud_digits = ['digits/one.wav', 'digits/two.wav', 'digits/three.wav', 'digits/four.wav', 'digits/five.wav', 'digits/six.wav', 'digits/seven.wav', 'digits/eight.wav', 'digits/nine.wav', 'digits/hindi_1.wav', 'digits/hindi_2.wav', 'digits/hindi_3.wav', 'digits/hindi_4.wav', 'digits/hindi_5.wav', 'digits/hindi_6.wav', 'digits/hindi_7.wav', 'digits/hindi_8.wav', 'digits/hindi_9.wav'];
function return_fds_adaptive_folder(){
		return aud_digits;
};
